...
<form name="room" action="${pageContext.request.contextPath}/addRoom.html" method="post">
    <p>Number</p>
    <input title="Number" type="text" name="roomNumber" value="${room.roomNumber}">
    <p>Type</p> <!--Можно добавить выпадающий список-->
    <input title="Type" type="text" name="roomType" value="${room.roomType}">
    <p>Capacity</p>
    <input title="Capacity" type="text" name="capacity" value="${room.capacity}">
    <p>Price</p>
    <input title="Price" type="text" name="price" value="${room.price}">
